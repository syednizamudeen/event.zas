...
@section('content')
    ...
    <!-- ====== About Area ====== -->
    <section id="about" class="section-padding about-area bg-secondary">
        <div class="container">
            <!-- Section Title -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-bg" style="background-image:url(main/images/img-1.jpg)">
                        <!-- Social Link -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 text-right cta-button">
                    <a href="faq.html" class="button">Show All</a>
                </div>
            </div>
        </div>
    </section>
